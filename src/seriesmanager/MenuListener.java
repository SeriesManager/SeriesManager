...
class MenuListener implements MouseListener, MouseMotionListener {
    ...
    /**
     * Methode appelé lors d'un click de la souris. Si le clic est sur l'un des
     * choux du menu : execute l'action associé.
     *
     * @param ev Evenemende la souris t lié au clic.
     */
    ...
    /**
     * Methode appelé lors d'un mouvement de la souris. Si la souris est sur un
     * des choix du menu : affiche un effet.
     *
     * @param ev Evenement de la souris lié au mouvement.
     */
