...
import static seriesmanager.Calendrier.Calendrier.MAIN_HEIGHT;
import static seriesmanager.Calendrier.Calendrier.NAVIGATION_HEIGHT;
import static seriesmanager.Calendrier.Calendrier.WINDOWS_WIDTH;
...
import seriesmanager.Calendrier.service.CalendrierService;
...
public abstract class PanelDefault extends JPanel implements PanelData {
	...
	this.setLayout(main);
	this.setLocation(5, NAVIGATION_HEIGHT + 30);
	main.setHgap(10);
	main.setVgap(5);
	setTitleAction();
    }
	...
	sb.append("<br/> <strong>Série </strong>:" + serie.getNumEpisode());
